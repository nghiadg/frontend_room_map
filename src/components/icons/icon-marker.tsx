...
export default function IconMarker({
  ...
  // Prefer `size` prop for both width and height if provided,
  // otherwise fall back to individual width, height or the default.
  const computedWidth =
    size !== undefined ? size : width !== undefined ? width : 33;
  const computedHeight =
    size !== undefined ? size : height !== undefined ? height : 44;
  ...
  return (
    <svg
      ...
      focusable="false"
    >
      <g clipPath="url(#clip0_11_547)">
        <g filter="url(#filter0_f_11_547)">
          <ellipse
            cx="12"
            cy="29"
            rx="4"
        ...
        <path
          ...
          fill="url(#paint0_linear_11_547)"
          mask="url(#path-2-outside-1_11_547)"
        />
      </g>
      <circle cx="12" cy="12" r="4" fill="black" fillOpacity="0.4" />
      <defs>
        <filter
          id="filter0_f_11_547"
          x="6"
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="1"
            result="effect1_foregroundBlur_11_547"
          />
        </filter>
        <linearGradient
          id="paint0_linear_11_547"
          x1="12"
          y1="2"
          x2="12"
          y2="27.9969"
